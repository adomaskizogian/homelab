...
Updates all packages, configures pubkey and hardens ssh setup, installs ansible. The resulting installation is minimal yet secure - just enough to handover further configuration to ansible.
